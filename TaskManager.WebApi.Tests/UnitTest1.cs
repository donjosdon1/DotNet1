...
namespace TaskManager.WebApi.Tests
{
    ...
    public class UnitTest1
    {
        ...
        public void GetTasksJoin()
        {
            ...
            Trace.Write("Records returned = " + ((System.Web.Http.Results.OkNegotiatedContentResult<System.Collections.Generic.List<TaskManager.Entities.TaskandParent>>)response).Content.Count);
            //Trace.Write(((System.Web.Http.Results.OkNegotiatedContentResult<string>)response).Content);
            // Assert
            //Assert.AreEqual(locationUrl, response.Headers.Location.AbsoluteUri);
